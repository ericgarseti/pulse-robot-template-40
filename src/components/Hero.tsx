      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Beyond Horizon: Where Innovation<br className="hidden sm:inline" />Meets Altitude
            </h1>
            ...
            >
              Advanced UAV systems engineered for the most critical missions across defence, government, and commercial sectors.
            </p>
