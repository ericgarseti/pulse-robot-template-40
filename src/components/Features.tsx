      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Advanced Technology, <br className="hidden sm:block" />Mission-Proven Results
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Engineered with aerospace excellence to deliver superior performance in the most demanding operations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Advanced AI-powered systems enable fully autonomous flight operations with real-time obstacle avoidance and mission planning."
            index={0}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><circle cx="12" cy="12" r="3"></circle><path d="M16.2 7.8l2.9-2.9M19.8 16.2l-2.9-2.9M7.8 7.8L4.9 4.9M4.2 19.1l2.9-2.9"></path></svg>}
            title="All-Weather Operations"
            description="Engineered for reliability in extreme conditions, from desert heat to arctic cold, ensuring mission success regardless of environment."
            index={1}
          />
          <FeatureCard
            ...
            title="Multi-Sector Service"
            description="Versatile platforms serving Government, Defence, Commercial, and NonProfit sectors with customizable payload configurations."
            index={2}
          />
          <FeatureCard
            ...
            description="Multi-spectral imaging, LiDAR, thermal cameras, and radar systems provide comprehensive situational awareness day or night."
            index={3}
          />
          <FeatureCard
            ...
            description="Military-grade encrypted data links ensure secure command and control with anti-jamming capabilities for critical operations."
            index={4}
          />
          <FeatureCard
            ...
            description="Quick-launch systems and modular design enable rapid field deployment, minimizing setup time and maximizing operational readiness."
            index={5}
          />
        </div>
      </div>
